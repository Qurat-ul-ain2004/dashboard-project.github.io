    ...
    async function fetchEvents() {
      try {
        const response = await fetch(
          "https://api.predicthq.com/v1/events?category=school-holidays%2Cpolitics%2Cfestivals%2Csports%2Cpublic-holidays%2Cconcerts&country=PK&limit=500&end_around.origin=2024-12-07",
          {
            headers: {
              Accept: "application/json",
              Authorization:"Bearer Ve4wvxn00Mz6s11XowYKTb_Vai-YRVGLa16cNIW1",
            },
          }
        );
